...
# TODO différencier la logique du modèle et l'initialisation
#	l'initialisation peut éventuellement reprendre un modèle déjà entrainé
#	la logique est l'enchainement des connexions noeuds à noeuds
